...
sourceShare = 'raw'
sinkShare = 'enriched'
input_file_name = 'organisationUnitGroups.json'
input_folder_name = 'organisationUnitGroups'
output_folder_name = 'organisationUnitGroups'
...
df_select = df.select('organisationUnitGroups_id','organisationUnitGroups_name','organisationUnitGroups_organisationUnits_id').distinct()

# COMMAND ----------

column = {
    "organisationUnitGroups_id":"id",
    "organisationUnitGroups_name":"name",
    "organisationUnitGroups_organisationUnits_id":"organisationUnits_id"
