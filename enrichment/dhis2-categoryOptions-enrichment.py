...
sourceShare = 'raw'
sinkShare = 'enriched'
input_file_name = 'categoryOptions.json'
input_folder_name = 'categoryOptions'
output_folder_name = 'categoryOptions'
...
df_select = df.select('categoryOptions_id','categoryOptions_name','categoryOptions_categoryOptionCombos_id').distinct()

# COMMAND ----------

column = {
    "categoryOptions_id":"id",
    "categoryOptions_name":"name",
    "categoryOptions_categoryOptionCombos_id":"categoryOptionCombos_id"
}
