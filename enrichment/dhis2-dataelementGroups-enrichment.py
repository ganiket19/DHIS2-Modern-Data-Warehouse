...
sourceShare = 'raw'
sinkShare = 'enriched'
input_file_name = 'dataElementGroups.json'
input_folder_name = 'dataElementGroups'
output_folder_name = 'dataElementGroups'
...
df_select = df.select('dataElementGroups_id','dataElementGroups_name','dataElementGroups_dataElements_id').distinct()

# COMMAND ----------

column = {
    "dataElementGroups_id":"id",
    "dataElementGroups_name":"name",
    "dataElementGroups_dataElements_id":"dataElements_id"
}
