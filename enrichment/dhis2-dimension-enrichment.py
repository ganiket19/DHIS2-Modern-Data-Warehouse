...
sourceShare = 'raw'
sinkShare = 'enriched'
input_file_name = 'dimension.json'
input_folder_name = 'dimension'
output_folder_name = 'dimension'
...
df_select = df.select('dimensions_dimensionType','dimensions_id','dimensions_name','dimensions_items_id').distinct()

# COMMAND ----------

column = {
    "dimensions_dimensionType":"dimensionType",
    "dimensions_id":"id",
    "dimensions_name":"name",
    "dimensions_items_id":"items_id"
