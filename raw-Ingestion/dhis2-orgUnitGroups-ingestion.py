...
import json
url = "https://play.dhis2.org/2.39.0/api/organisationUnitGroups?paging=false&fields=id,name,organisationUnits"
...
sourceShare = 'raw'
json_file_name = 'organisationUnitGroups.json'
output_path = 'organisationUnitGroups'
