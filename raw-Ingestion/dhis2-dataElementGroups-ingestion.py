...
import json
url = "https://play.dhis2.org/2.39.0/api/dataElementGroups?paging=false&fields=id,name,dataElements"
...
sourceShare = 'raw'
json_file_name = 'dataElementGroups.json'
output_path = 'dataElementGroups'
