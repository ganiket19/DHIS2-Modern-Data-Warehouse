...
import json
url = "https://play.dhis2.org/2.39.0/api/categoryOptionGroups?paging=false&fields=id,name,categoryOptions"
...
sourceShare = 'raw'
json_file_name = 'categoryOptionGroups.json'
output_path = 'categoryOptionGroups'
